...
const cursos = [
  {
    ...
    promedio: 15.4,
    trabajos: [
      { id: 'E01', titulo: 'Entregable - E01', enviado: '16/8/25', nota: 14.0, icon: '📄' },
      { id: 'participacion', titulo: 'Participación', nota: 15.0, icon: '📄' },
      { id: 'IP_empresa', titulo: 'Nota IP_empresa', nota: 15.0, icon: '📄' },
    ],
    linkTrabajos: 9,
  },
  {
    id: 'PREVENCION-202510-25',
    titulo: 'CURSO OBLIGATORIO: Comportamiento seguro - Prevención',
    color: '#007BFF',
    promedio: null,
    trabajos: [],
    linkTrabajos: 1,
  ...
  },
  {
    ...
    promedio: 14.8,
    trabajos: [
      { id: 'IP01', titulo: 'Informe de Práctica IP01', enviado: '9/8/25', nota: 14.0, icon: '📄' },
      { id: 'actitudes', titulo: 'Actitudes', nota: 15.0, icon: '📄' },
      { id: 'Tarea01', titulo: 'Tarea 01', enviado: '8/8/25', nota: 15.0, icon: '📅' },
    ],
    linkTrabajos: 15,
  },
  {
    ...
    promedio: null,
    trabajos: [
      { id: 'asistencia', titulo: 'Asistencia', nota: '50/100', icon: '📅' },
